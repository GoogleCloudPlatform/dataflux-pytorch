...
function run_integration_tests(){
    ...
    echo Running image_segmentation benchmark.
    ...
    python3 -u ./benchmark/checkpointing/singlenode/train.py --project=dataflux-project --ckpt-dir-path=gs://df-ckpt-presubmit/ --layers=1000 --steps=5
    echo Running single node async checkpointing benchmark.
    python3 -u ./benchmark/checkpointing/singlenode/train.py --project=dataflux-project --ckpt-dir-path=gs://df-ckpt-presubmit/async/ --layers=1000 --steps=5 --checkpoint=async_df_lightning
