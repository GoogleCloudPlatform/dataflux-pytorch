...
function run_integration_tests(){
    ...
    python3 dataflux_pytorch/benchmark/lightning_checkpoint_benchmark.py --enable-multipart --project=dataflux-project --ckpt-dir-path=gs://jd-upload-west/ --dataflux-ckpt --layers=10 --steps=5
}
